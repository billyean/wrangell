...
public class MulltiTierKeywordLookupServiceTest {
    KeywordLookupService service = new MulltiTierKeywordLookupService();
    ...
    public void testLookup1() {
        ...
        Assert.assertEquals("facial tissue", bestBid123.getKeywords());
        Assert.assertEquals(BROAD, bestBid123.getMatchType());
        Assert.assertEquals(0.75, bestBid123.getCpc(), 0.0);

        ParsedKeywordBid bestBid345 = bestBids.get(345221);
        Assert.assertEquals("facial tissue paper", bestBid345.getKeywords());
        Assert.assertEquals(EXACT, bestBid345.getMatchType());
        Assert.assertEquals(0.9, bestBid345.getCpc(), 0.0);
    }
